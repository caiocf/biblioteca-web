          ...
          <div id="main">
              ...
              <div className="content">
                  ...
                  <p>
                      ...
                      href="/layouts/side-menu/styles.css" alt="Side Menu CSS">side-menu.css</a>, and the JavaScript
                      in <a href="/js/ui.js">ui.js</a>. The JS file uses vanilla JavaScript to simply toggle
                      an <code>active</code> class that makes the menu responsive.
                  </p>
                  ...
                  <div className="pure-g">
                      <div className="pure-u-1-4">
                          <img className="pure-img-responsive"
                               src="http://farm3.staticlicr.com/2875/9069037713_1752f5daeb.jpg" alt="Peyto Lake"></
                               img>
                      </div>
                      <div className="pure-u-1-4">
                          <img className="pure-img-responsive"
